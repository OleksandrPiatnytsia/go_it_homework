...
LST = [{"name": "Jasey", "birthday": "1990-3-19"},
       ...
       {"name": "Bill", "birthday": "1990-3-24"},
       {"name": "Brayan", "birthday": "1990-3-24"},
       {"name": "Bily", "birthday": "1990-3-22"},
...
def get_birthdays_per_week(birthday_list: list[dict[str:str]]) -> dict:
    ...
    for birthday_dict in birthday_list:
        ...
        person_birthday_in_this_year = datetime(year=today.year, month=int(lst_b_person[1]), day=int(lst_b_person[2])).date()

        if person_birthday_in_this_year in days_of_week:

            day_week_day = person_birthday_in_this_year.weekday()
